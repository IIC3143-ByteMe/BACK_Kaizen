...
async def get_user_progress(user_id: str, current_admin: TokenData = Depends(require_admin)):
...
async def admin_delete_habit(habit_id: str, current_admin: TokenData = Depends(require_admin)):
